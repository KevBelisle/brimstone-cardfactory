  ...
  render: function () {
    if (this.model.get("label") == "Spacer") {
      this.$el.html(
        "<label><span class='title'>" +
          this.model.get("label") +
          ":</span><a class='remove'>X</a><input type='text' class='yOffset' value='" +
          this.model.get("yOffset") +
          "'></label>",
      );
      ...
      this.$el.html(
        "<label><span class='title'>" +
          this.model.get("label") +
          ":</span><a class='remove'>X</a><textarea class='content'>" +
          this.model.get("content") +
          "</textarea></label>",
      );
    } else {
      this.$el.html(
        "<label><span class='title'>" +
          this.model.get("label") +
          ":</span><a class='remove'>X</a><input type='text' class='content' value='" +
          this.model.get("content") +
          "'></label>",
      );
    }
    ...
    if (this.model.get("multiline")) {
      this.$el.html(
        "<label><input type='checkbox' class='enabled' /><span class='title'>" +
          this.model.get("label") +
          ":</span></label><textarea class='content'>" +
          this.model.get("content") +
          "</textarea>",
      );
    } else {
      this.$el.html(
        "<label><input type='checkbox' class='enabled' /><span class='title'>" +
          this.model.get("label") +
          ":</span></label><input type='text' class='content' value='" +
          this.model.get("content") +
          "'>",
      );
    }
