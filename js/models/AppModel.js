...
var App = Backbone.Model.extend({
	initialize: function () {
		...
		this.set("cardTypes", new Backbone.Collection([
			{model: GearCard},
			{model: TownItemCard},
			{model: ConditionCard},
			{model: ThreatCard},
	...
	loadAssets: function (callback) {
		...
		this.loadFonts(["berylium", "rockwell condensed", "dust west"],
			function() {
		...
		$.when.apply($, imagesLoaded.concat([fontsLoaded.promise(),]).concat([minimumWait.promise(),]) ).then( 
			$.proxy(callback, this)
		);
