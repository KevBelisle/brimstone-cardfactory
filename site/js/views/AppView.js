var AppView = Backbone.View.extend({
  ...
  render: function () {
    ...
    this.$el.append(
      "<div id='cardSelectorWrapper'><div id='cardSelector'></div></div>",
    );
    this.model.get("cardTypes").each(this.renderCardType, this);

    this.$el.append("<div id='editor'></div>");
    this.$el.append(
      "<div id='cardWrapper'><canvas id='cardCanvas' width='900' height='1200'></canvas><img id='cardImg' /><p>To save your card: right-click and 'Save image as...'</p></div>",
    );
...
var CardTypeView = Backbone.View.extend({
  ...
  render: function () {
    this.$el
      .addClass("changeCardType")
      .append("<img src='" + this.img + "' />" + this.label);
  },
